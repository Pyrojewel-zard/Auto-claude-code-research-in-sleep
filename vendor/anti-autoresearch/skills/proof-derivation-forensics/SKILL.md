...
```
$TRACE_DIR/
  run.meta.json                  # {skill, paper_id, run_level_L, taxonomy_version:"0.6", has_proofs, generated_at}
...
|------|---------|---------|
| `run.meta.json` | Step 5 | `{skill, paper_id, run_level_L, taxonomy_version:"0.6", has_proofs, generated_at}` |
