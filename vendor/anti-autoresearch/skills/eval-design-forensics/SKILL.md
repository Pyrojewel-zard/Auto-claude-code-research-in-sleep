...
TAXONOMY_VERSION      = 0.6                      # references/hack-pattern-taxonomy.md (family H)
...
.aris/traces/eval-design-forensics/<date>_run<NN>/
  run.meta.json                       # {skill, paper_id, run_level_L, taxonomy_version:"0.6", leakage_taxonomy:"K&N 2023", generated_at, not_applicable?}
