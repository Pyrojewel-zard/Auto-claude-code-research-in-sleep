...
TAXONOMY_VERSION     = 0.6                     # references/hack-pattern-taxonomy.md
...
`{"skill":"novelty-duplication-advisory","paper_id":"<PAPER_ID>","run_level_L":<L>,"taxonomy_version":"0.6","retrieval":{"duplicate":"pending","combination":"pending"},"generated_at":"<UTC ISO-8601>"}`.
...
- **Taxonomy is a mapping layer (v0.6).** The two `ADV-*` ids are advisory signals with zero
