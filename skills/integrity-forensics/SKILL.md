...
description: Use when a historical ARIS integrity-forensics request must be migrated to the full independent Anti-Autoresearch audit.
argument-hint: "[frozen-artifact-directory]"
---

# Integrity-forensics compatibility entry

New work uses `/research-audit`, whose canonical contract is
`skills/skills-codex/research-audit/SKILL.md`. It runs the ARIS-vendored
...
`/research-audit`; preserve `REVIEW_UNAVAILABLE`, `HARD_FLAGS`, `SOFT_FLAGS`, and
